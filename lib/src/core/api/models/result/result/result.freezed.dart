...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Success<T> value)?  ok,TResult Function( Failure<T> value)?  err,required TResult orElse(),}){
final _that = this;
switch (_that) {
case Success() when ok != null:
return ok(_that);case Failure() when err != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Success<T> value)  ok,required TResult Function( Failure<T> value)  err,}){
final _that = this;
switch (_that) {
case Success():
return ok(_that);case Failure():
return err(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Success<T> value)?  ok,TResult? Function( Failure<T> value)?  err,}){
final _that = this;
switch (_that) {
case Success() when ok != null:
return ok(_that);case Failure() when err != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  ok,TResult Function( BetterError error)?  err,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when ok != null:
return ok(_that.data);case Failure() when err != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  ok,required TResult Function( BetterError error)  err,}) {final _that = this;
switch (_that) {
case Success():
return ok(_that.data);case Failure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  ok,TResult? Function( BetterError error)?  err,}) {final _that = this;
switch (_that) {
case Success() when ok != null:
return ok(_that.data);case Failure() when err != null:
return err(_that.error);case _:
