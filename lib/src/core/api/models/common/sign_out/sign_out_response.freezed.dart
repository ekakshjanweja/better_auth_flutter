...
bool operator ==(Object other) {
  final _this = this as SignOutResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignOutResponse&&(identical(other.success, _this.success) || other.success == _this.success));
}
...
String toString() {
  final _this = this as SignOutResponse;
  return 'SignOutResponse(success: ${_this.success})';
}
