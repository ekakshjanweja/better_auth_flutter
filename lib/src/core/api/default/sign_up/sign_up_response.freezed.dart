...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignUpResponse&&(identical(other.token, _this.token) || other.token == _this.token)&&(identical(other.user, _this.user) || other.user == _this.user)&&(identical(other.status, _this.status) || other.status == _this.status));
}
...
int get hashCode {
  final _this = this as SignUpResponse;
  return Object.hash(runtimeType,_this.token,_this.user,_this.status);
}

@override
String toString() {
  final _this = this as SignUpResponse;
  return 'SignUpResponse(token: ${_this.token}, user: ${_this.user}, status: ${_this.status})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,token,user,status);
}
