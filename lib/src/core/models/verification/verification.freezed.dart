...
int get hashCode {
  final _this = this as Verification;
  return Object.hash(runtimeType,_this.id,_this.identifier,_this.value,_this.expiresAt,_this.createdAt,_this.updatedAt);
}

@override
String toString() {
  final _this = this as Verification;
  return 'Verification(id: ${_this.id}, identifier: ${_this.identifier}, value: ${_this.value}, expiresAt: ${_this.expiresAt}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,identifier,value,expiresAt,createdAt,updatedAt);
}
