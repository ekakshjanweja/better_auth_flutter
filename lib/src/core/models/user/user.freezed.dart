...
int get hashCode {
  final _this = this as User;
  return Object.hash(runtimeType,_this.id,_this.name,_this.email,_this.emailVerified,_this.image,_this.createdAt,_this.updatedAt,_this.twoFactorEnabled,_this.username,_this.displayUsername,_this.isAnonymous,_this.phoneNumber,_this.phoneNumberVerified,_this.role,_this.banned,_this.banReason,_this.banExpires,const DeepCollectionEquality().hash(_this.additionalFields));
}

@override
String toString() {
  final _this = this as User;
  return 'User(id: ${_this.id}, name: ${_this.name}, email: ${_this.email}, emailVerified: ${_this.emailVerified}, image: ${_this.image}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, twoFactorEnabled: ${_this.twoFactorEnabled}, username: ${_this.username}, displayUsername: ${_this.displayUsername}, isAnonymous: ${_this.isAnonymous}, phoneNumber: ${_this.phoneNumber}, phoneNumberVerified: ${_this.phoneNumberVerified}, role: ${_this.role}, banned: ${_this.banned}, banReason: ${_this.banReason}, banExpires: ${_this.banExpires}, additionalFields: ${_this.additionalFields})';
}
