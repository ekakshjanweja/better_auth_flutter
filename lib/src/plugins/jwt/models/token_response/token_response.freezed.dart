...
bool operator ==(Object other) {
  final _this = this as JwtTokenResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JwtTokenResponse&&(identical(other.token, _this.token) || other.token == _this.token));
}
...
String toString() {
  final _this = this as JwtTokenResponse;
  return 'JwtTokenResponse(token: ${_this.token})';
}
