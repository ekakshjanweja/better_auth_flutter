...
bool operator ==(Object other) {
  final _this = this as CheckPermissionResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CheckPermissionResponse&&(identical(other.success, _this.success) || other.success == _this.success)&&(identical(other.error, _this.error) || other.error == _this.error));
}
...
int get hashCode {
  final _this = this as CheckPermissionResponse;
  return Object.hash(runtimeType,_this.success,_this.error);
}

@override
String toString() {
  final _this = this as CheckPermissionResponse;
  return 'CheckPermissionResponse(success: ${_this.success}, error: ${_this.error})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? success = null,Object? error = freezed,}) {
  return _then(CheckPermissionResponse(
...
@override
int get hashCode {
    return Object.hash(runtimeType,success,error);
}
