...
int get hashCode {
  final _this = this as ResetPhonePasswordBody;
  return Object.hash(runtimeType,_this.otp,_this.phoneNumber,_this.newPassword);
}

@override
String toString() {
  final _this = this as ResetPhonePasswordBody;
  return 'ResetPhonePasswordBody(otp: ${_this.otp}, phoneNumber: ${_this.phoneNumber}, newPassword: ${_this.newPassword})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? otp = null,Object? phoneNumber = null,Object? newPassword = null,}) {
  return _then(ResetPhonePasswordBody(
...
@override
int get hashCode {
    return Object.hash(runtimeType,otp,phoneNumber,newPassword);
}
