...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SendOTPResponse&&(identical(other.message, _this.message) || other.message == _this.message));
}
...
String toString() {
  final _this = this as SendOTPResponse;
  return 'SendOTPResponse(message: ${_this.message})';
}
