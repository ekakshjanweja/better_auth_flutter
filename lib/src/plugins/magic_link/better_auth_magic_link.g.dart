...
part of 'better_auth_magic_link.dart';
...
class _BetterAuthMagicLink implements BetterAuthMagicLink {
  _BetterAuthMagicLink(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<Result<StatusResponse>> signIn({required MagicLinkBody body}) {
    return BetterAuthCallAdapter<StatusResponse>().adapt(
      () => _signIn(body: body),
    );
  }

  Future<HttpResponse<SignInEmailResponse>> _verify({
